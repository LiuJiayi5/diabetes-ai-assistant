...
DROP TABLE IF EXISTS intervention_reviews;
...
DROP TABLE IF EXISTS article_read_events;
DROP TABLE IF EXISTS article_recommendation_logs;
...
CREATE TABLE life_plans (
    ...
    KEY idx_life_plans_source_review (source_review_id),
...
CREATE TABLE article_recommendation_logs (
